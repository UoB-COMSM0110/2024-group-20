public class Tutorial {
  ...
  Tutorial() {
    ...
    menus[0] = new Menu(width/2-width/4, height/2-height/4, width/2, height/2,"Welcome to Anxious Pigs! Here is a tutorial ,click NEXT to go next, click SKIP to skip.",1, totalSteps, this::nextStep, this::skipTutorial);
