public class Tutorial {
  ...
  public Tutorial() {
    ...
    menus[2] = new Menu(width/3, 3 * height/5, width/3, height/3, "Click buttons on the left to buy or delete a material block, place them to build structures protecting pigs.", 3, totalSteps, this::nextStep, this::skipTutorial);
