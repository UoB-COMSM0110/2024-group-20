...
void setup (){
  ...
  w.addBody(new Circle(new PVector(width/4*2,height/3), 2, 0, false, 50, 0));
  ...
  //w.addBody(new Rectangle(new PVector(0,height/2), Float.MAX_VALUE/100000, 1, true, 2, height, 0));
